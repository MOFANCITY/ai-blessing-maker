...
基于 Next.js 15 + TypeScript 构建的 **灵言 (Lingyan)** 产品后端，为微信小程序 [`blessing-elf`](../blessing-elf/) 提供 API。支持多 AI 供应商切换，为 4 个核心功能生成个性化中文文本。

> **产品品牌：** 灵言 · Tagline：以 AI 传心意
> **小程序介绍文案：** 见 [`blessing-elf/doc/MINI_PROGRAM_STORE.md`](../blessing-elf/doc/MINI_PROGRAM_STORE.md)

## ✨ 核心功能（4 个 AI 能力）

1. **AI 祝福** — 选对象、选场景、选风格，AI 写中文祝福
2. **AI 怼人** — 选场景 + 选语气，AI 写优雅回击
3. **AI 对联** — 选主题 + 选难度，AI 出上联
4. **AI 古诗** — 选类型（五言/七言）+ 选主题，AI 起承，用户转合
