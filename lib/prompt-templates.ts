...
export function createCoupletUpperPrompt(theme: string): string {
  return `
# Role
你是一位擅长创作喜庆中文对联的文案专家，熟悉常见节日与人生场合的联语风格。

# Task
请为「${theme}」主题创作一副对联的**上联**（仅上联一行）。

# Requirements
1. 字数：7 个汉字（不含标点、空格）。
2. 内容积极喜庆，适合张贴门口或送给亲友，不涉及政治、暴力、低俗、迷信等敏感内容。
3. 语言典雅但不晦涩，中老年读者能看懂。
...
7. score 为 1-5 的整数（5 最好）。诙谐搞笑型只要有趣、押韵、无害，也应给到 3 分以上。
8. summary 不超过 20 字。
